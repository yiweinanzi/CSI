...
.venv-core-formal-20260819T091049Z/bin/python -B -m formal_v2.formal_cli all \
  ...
  --dataset runs/smoke-full-v6-p8-clusterfix-20260826T230312Z.fixture.npz \
  --output runs/smoke-full-v6-p8-clusterfix-20260826T230312Z \
  ...
  --approval-manifest /root/xunlian/Futaoran/formal_external_inputs/run_approvals/smoke-full-v6-p8-clusterfix-20260826T230312Z/LLM_JUDGE_APPROVAL.json \
  >> /tmp/smoke-full-v6-p8-clusterfix-20260826T230312Z.all.log 2>&1
smoke_exit=$?
printf '%s\n' "$smoke_exit" > /tmp/smoke-full-v6-p8-clusterfix-20260826T230312Z.all.exit
exit "$smoke_exit"
