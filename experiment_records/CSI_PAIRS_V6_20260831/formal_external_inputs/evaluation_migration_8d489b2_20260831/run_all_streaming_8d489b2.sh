...
run_root=runs/formal-v6-streaming-8d489b2-d7d0b8affcd40f05
accepted="$runtime_root/$run_root/migration/accepted.json"
log=/root/xunlian/Futaoran/formal_external_inputs/logs/formal-v6-streaming-8d489b2-d7d0b8affcd40f05.all.log
