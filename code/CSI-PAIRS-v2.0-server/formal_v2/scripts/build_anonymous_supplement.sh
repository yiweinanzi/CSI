...
(
  ...
  tar \
    ...
    --exclude='formal_v2/formal_evaluation_subset_compare.py' \
    --exclude='formal_v2/formal_migration.py' \
    --exclude='formal_v2/formal_migration_evidence.py' \
    ...
    --exclude='formal_v2/tests/test_adapter_root_separation.py' \
    --exclude='formal_v2/tests/test_cli_migration_control.py' \
    --exclude='formal_v2/tests/test_evaluation_subset_compare.py' \
    --exclude='formal_v2/tests/test_formal_data_pilot_projection.py' \
    --exclude='formal_v2/tests/test_formal_migration.py' \
    --exclude='formal_v2/tests/test_formal_upstream.py' \
    --exclude='formal_v2/tests/test_migration_cli_acceptance.py' \
    --exclude='formal_v2/tests/test_migration_evidence_tools.py' \
